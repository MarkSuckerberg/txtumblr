/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b799099977e81a9c6192490a81c3d527)
// Runtime types generated with workerd@1.20260708.1 2026-03-17 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	TUMBLR_CONSUMER_KEY: string;
	TUMBLR_CONSUMER_SECRET: string;
	TUMBLR_INITIAL_REFRESH_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TUMBLR_CONSUMER_KEY" | "TUMBLR_CONSUMER_SECRET" | "TUMBLR_INITIAL_REFRESH_TOKEN" | "CACHE_CLEAR_TOKEN">> {}
}
